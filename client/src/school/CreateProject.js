...
import SchoolNavBar from "../components/SchoolNavBar.js";
...
function getStepContent(
  ...
  switch (step) {
    case 0:
      return (
        <div>
          <div className="CreateProjectTitle">Project Name</div>
          ...
          <div className="CreateProjectTitle">Project Description</div>
    ...
    case 1:
      return (
        <div>
          <div className="CreateProjectTitle">Target Funding</div>
            ...
            <Form>
              <FormGroup className="FundingAmt">
                ...
                <Input
                  ...
                  name="text2"
                  id="amount3"
                  placeholder="Enter amount of funding needed"
                  style={{
                    backgroundColor: "#ECF3FF",
                    color: "black",
                    borderRadius: "10px",
          ...
          <div className="CreateProjectTitle">Funding Breakdown</div>
    ...
    case 2:
      return (
        <div>
          <div className="CongratulationsCreateProject">Congratulations!</div>

          <div className="CreateProjectsFinished">
            {" "}
            The project is now created! You can view the details on the projects
            page.
          </div>
...
export default function CreateProject(props) {
  ...
  const handleRequest = async () => {
    ...
    inputList.forEach((element) => {
      fundingBreakdown[element.percent] = element.category;
    });
  ...
  return (
    <div className={classes.root}>
      <SchoolNavBar
        Balance={props.location.Balance}
        Withdraw={props.location.Withdraw}
        Name={props.location.Name}
        activeTab={props.location.activeTab}
      />
