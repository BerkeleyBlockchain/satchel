...
class Login extends Component {
    ...
    login = async (e) => {
        ...
        web3.eth.getAccounts(function(error, accounts) {
          ...
          School.deployed().then(async function(instance) {
            ...
            if (userContractAddress == "0x0000000000000000000000000000000000000000") {
                await schoolInstance.createUserContract(
                    self.state.Name,
                    {from: accounts[0]}
                );
            ...
            self.props.history.push({pathname: "/Dashboard", state: {UserContractAddress: self.state.UserContractAddress}});
          }).catch(function(err) {
            ...
            <div className="LoginItems">
                  ...
                  <Form>
                    <FormGroup className="NameField">
                      ...
                      <Input onChange={this.setName} type="text" name="text" id="amount" placeholder="Enter your name" style={{ backgroundColor:"#ECF3FF", color:"black", borderRadius:"10px", border:"white", fontSize: "15px"}} />
                    </FormGroup>
                  ...
                  <div className="SchoolLogin">
                    <Button className="Button" onClick={this.schoolLogin} type="submit" style={{ backgroundColor:"white", color:"#146EFF", borderWidth:"0px"}}>I'm a school!</Button>
                  </div>
              </div>
          </div>
        );
